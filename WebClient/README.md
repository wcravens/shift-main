...
The SHiFT front-end uses Thrift to create an API for the LibCoreClient libraries. When modifications regarding thrift are made, it is necessary to regenerate the Thrift files generated from shift_service.thrift.
