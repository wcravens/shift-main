...
// TODO: change the names and order of parameters: username, orderType, orderSymbol, orderSize, orderPrice, orderID
// TODO: orderSize and orderPrice do not need to be "const" (is it a requirement?)
// TODO: is it possible to make orderPrice and orderID optional? (i.e. set the parameters as double orderPrice == 0.0, const std::string& orderID = 0.0)
...
void SHIFTServiceHandler::submitOrder(const std::string& stockName, const std::string& orderID, const double price, const int32_t shareSize, const std::string& orderType, const std::string& username)
{
    ...
    shift::Order order(type, stockName, shareSize, price); // new order IDs are generated by the constructor of Order
