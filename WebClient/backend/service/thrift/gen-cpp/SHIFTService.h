...
public:
    ...
    SHIFTService_registerUser_args()
        : username()
        , firstname()
        , lastname()
        , email()
...
public:
    ...
    SHIFTService_registerUser_result()
        : success()
    {
    }
...
public:
    ...
    SHIFTService_webUserLoginV2_args()
        : username()
        , password()
    {
    }
...
public:
    ...
    SHIFTService_webUserLoginV2_result()
        : success()
    {
    }
...
public:
    ...
    SHIFTService_change_password_args()
        : cur_password()
        , new_password()
        , username()
    {
...
public:
    ...
    SHIFTService_change_password_result()
        : success()
    {
    }
...
public:
    ...
    SHIFTService_get_user_by_username_args()
        : username()
    {
    }
...
public:
    ...
    SHIFTService_get_user_by_username_result()
        : success()
    {
    }
...
public:
    ...
    SHIFTService_getAllTraders_result()
        : success()
    {
    }
...
public:
    ...
    SHIFTService_getThisLeaderboard_args()
        : startDate("")
        , endDate("")
    {
    }
...
public:
    ...
    SHIFTService_getThisLeaderboard_result()
        : success()
    {
    }
...
public:
    ...
    SHIFTService_getThisLeaderboardByDay_args()
        : contestDay(0)
    {
    }
...
public:
    ...
    SHIFTService_getThisLeaderboardByDay_result()
        : success()
    {
    }
