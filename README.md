...
# Ubuntu:
cmake -DCMAKE_CXX_STANDARD=17 -DCMAKE_BUILD_TYPE=RelWithDebInfo -DHAVE_SSL=ON ..
# Raspbian:
cmake -DCMAKE_CXX_STANDARD=17 -DCMAKE_CXX_FLAGS="${CMAKE_CXX_FLAGS} -DENABLE_BOOST_ATOMIC_COUNT" -DCMAKE_BUILD_TYPE=RelWithDebInfo -DHAVE_SSL=ON ..
# macOS:
cmake -DCMAKE_CXX_STANDARD=17 -DCMAKE_BUILD_TYPE=RelWithDebInfo -DHAVE_SSL=ON -DOPENSSL_ROOT_DIR=/usr/local/opt/openssl ..
