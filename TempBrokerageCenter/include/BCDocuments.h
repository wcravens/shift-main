...
public:
    ...
    bool manageSubscriptionInOrderBook(bool isSubscript, const std::string& symbol, const std::string& username) const;
    bool manageSubscriptionInCandlestickData(bool isSubscript, const std::string& username, const std::string& symbol);
    ...
    void unregisterTargetFromDoc(const std::string& username); // for connection
    ...
    void unregisterTargetFromOrderBooks(const std::string& username);
    void unregisterTargetFromCandles(const std::string& username);
