...
BOOST_AUTO_TEST_CASE(CANCELASKTEST)
{
    ...
    Order limitsell(stockName, limitSellPrice, TESTSIZE, shift::Order::Type::LIMIT_SELL);
    ...
    Order cancelAsk(stockName, limitSellPrice, TESTSIZE, shift::Order::Type::CANCEL_ASK, orderID);
