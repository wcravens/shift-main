...
{
    // == true iff. the status flags of cout is cleared; the mutex locking incurs overhead but we don't need such locking anyway if no --verbose option set; see VerboseOptHelper's impl.
    if (cout) {
